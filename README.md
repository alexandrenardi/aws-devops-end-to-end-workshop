...
3. Clone repositories in Cloud9
   ...
   - Repository demobookstore-BooksService (for Books microservice with lambda functions related to books)
     ...
     - In the Source Code tab in the navigation, commit your code (insert a description and type Ctrl+Enter). Right click the menu on demobookstore-BooksService and push the changes to the repository (this can also be done by clicking 0↓1↑ in the bottom-left corner)
